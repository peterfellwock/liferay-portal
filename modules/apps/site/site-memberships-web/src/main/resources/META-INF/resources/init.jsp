...
page import="com.liferay.site.admin.search.UserGroupGroupRoleRoleChecker" %><%@
page import="com.liferay.site.admin.search.UserGroupRoleRoleChecker" %><%@
page import="com.liferay.site.admin.search.OrganizationSiteMembershipChecker" %><%@
page import="com.liferay.site.admin.search.UserGroupSiteMembershipChecker" %><%@
page import="com.liferay.site.admin.search.UserSiteMembershipChecker" %><%@
