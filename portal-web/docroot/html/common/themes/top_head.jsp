...
<link href="<%= HtmlUtil.escapeAttribute(PortalUtil.getStaticResourceURL(request, PortalWebResourcesUtil.getContextPath() + "/html/css/main.css")) %>" rel="stylesheet" type="text/css" />
